...
#Task 3: 
# Find the highest midday temperature and output it and the day to the user
# Find the lowest midnight temperature and output it and the day to the user

'''
FIND and store highest value in midday list
FIND and store lowest value in midnight list
Find this value in miidday list
