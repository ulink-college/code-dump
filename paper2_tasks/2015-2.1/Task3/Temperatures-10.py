...
#Calculate Averages:
middayAverage = middayTotal / DAYS                  #Why use a new variable to store the average?
midnightAverage = midnightTotal / DAYS              #Why not just 'print("Average temp is", midnightTotal/30)'?

#OUTPUT TO SCREEN
print("Average midday temperature is",middayAverage)
print("Average midnight temperature is",midnightAverage)

#Task 3: 
# Find the highest midday temperature and the day and output it and the day to the user
# Find the lowest midnight temperature and the day and output it and the day to the user
'''
FIND and store highest value in midday list
FIND and store lowest value in midnight list
Find this value in midday list
    PRINT the temperature and index value +1
Find this value in midnight list
    PRINT the index value +1
    
#PSEUDOCODE

highestTemp <-- -11
FOR i in range 1 to 30
    IF middayTemp[i] > highestTemp:
        highestTemp = middayTemp[i]
NEXT


#Find the index for this number:
hottestDay = middayTemp.index(highestTemp)
print("Hottest day was", hottestDay+1 )
'''

highestTemp = -11
for i in range(0,DAYS):
    if middayTemperature[i] > highestTemp:
        highestTemp = middayTemperature[i]

hottestDay = middayTemperature.index(highestTemp)
print("The hottest day was", highestTemp,"degrees on day", hottestDay + 1)
