...
#TODO: Add any other variables or constants you might need:

#TODO:  Add values to your lists
...
#TODO: Write the code here to ask the user for the temperature and then add this to the correct list and repeat

#TODO: Check that the number is with in a valid range
#       What problems might you encounter when doing this?
