...
while answer != "Mississippi": 
    ...
    if answer!="Mississippi": 
        time+=1                                                 #Is this the best location for this line of code?
        ...
        print("Well down!You solve this riddle!Number of total times: %d times"%(time + 1))         #A few formatting changes....